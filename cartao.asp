...
<html>
<head>
  <title>Exemplo Cart�o | Gateway de Pagamentos</title>
</head>
<body>
  <h1>Exemplo Cart�o</h1>
<%
...
%>
  <form method="post" action="cartao.asp">
    ...
    Tipo de opera��o: <select name="PagamentoTipoOperacao">
      <option value="credito_a_vista">Cr�dito � vista</option>
    ...
    <br />Cart�o<br />
    N�mero: <input type="text" name="PagamentoCartaoNumero" value="" /><br />
    ...
    Descri��o: <input type="text" name="PedidoDescricao" value="Pedido de teste Locaweb" /><br />
